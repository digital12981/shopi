        ...
        <div className="w-full mx-auto p-6 mb-8">
              ...
              <form onSubmit={tedForm.handleSubmit(handleTedSubmit)} className="space-y-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    placeholder="Número da conta com dígito (ex: 12345-6)"
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div
                      className={`border p-4 rounded-md cursor-pointer flex items-center ${
                        tedForm.watch('tipoConta') === 'corrente' 
                          ? 'border-[#E83D22] bg-[#FFF8F6]' 
                          : 'border-gray-200 hover:border-[#E83D2280]'
                      }`}
                      onClick={() => tedForm.setValue('tipoConta', 'corrente')}
                    >
                      <input
                        type="radio"
                        className="h-4 w-4 text-[#E83D22] border-[#E83D22]"
                        checked={tedForm.watch('tipoConta') === 'corrente'}
                        onChange={() => {}}
                      />
                      <span className="ml-2">Conta Corrente</span>
                    </div>
                    <div
                      className={`border p-4 rounded-md cursor-pointer flex items-center ${
                        tedForm.watch('tipoConta') === 'poupanca' 
                          ? 'border-[#E83D22] bg-[#FFF8F6]' 
                          : 'border-gray-200 hover:border-[#E83D2280]'
                      }`}
                      onClick={() => tedForm.setValue('tipoConta', 'poupanca')}
                    >
                      <input
                        type="radio"
                        className="h-4 w-4 text-[#E83D22] border-[#E83D22]"
                        checked={tedForm.watch('tipoConta') === 'poupanca'}
                        onChange={() => {}}
                      />
                      <span className="ml-2">Conta Poupança</span>
                    </div>
                  </div>
                </div>
          ...
          {metodo === MetodoPagamento.NENHUM && (
            <div className="mt-2 text-center">
              <p className="text-gray-600">Por favor, selecione um método de recebimento acima.</p>
            </div>
          )}
          ...
          <div className="mt-8 text-center">
            <a
              href="/selfie"
              className="text-[#E83D22] hover:text-[#d73920] font-medium text-sm mt-4 inline-block"
            >
              Voltar para selfie
            </a>
          </div>
